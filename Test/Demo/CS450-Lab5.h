...
#define ROTATE_RATE_EARTH .01
#define ROTATE_RATE_MOON .02
#define ROTATE_RATE_SUN .05
#define ROTATE_RATE_MARS .15
#define ORBIT_RADIUS_X 1
#define ORBIT_RADIUS_Z 2
#define PI 3.1415
